...
# ─────────────────────────────────────────
# Handle hidden missing values in TotalCharges (some are blank strings)
...
top_features = pd.concat([
    feature_importance.head(5),   # Top 5 retention drivers
    feature_importance.tail(5)    # Top 5 churn drivers
])
